...
media_idade = df_alunos['Idade'].mean(axis=0) #axis é o eixo
...
media_media = df_alunos['Média'].mean(axis=0) #axis é o eixo
...
print(f"O nome do aluno com a melhor média é {maior_media_nome.values[0]}")
print(f"O nome do aluno com a pior média é {menor_media_nome.values[0]}")
